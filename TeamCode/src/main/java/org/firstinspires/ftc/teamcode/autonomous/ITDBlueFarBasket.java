...
public class ITDBlueFarBasket extends IntoTheDeepAutonomousBlue {
    ...
    public void runOpMode() {
        Pose2d initialPose = new Pose2d(-12, 60, Math.toRadians(90)); //ALL NUMBERS BASED ON 15in TRACK WIDTH
        ...
        TrajectoryActionBuilder pickupSample2 = drive.actionBuilder(new Pose2d(-55,-55, Math.toRadians(-315)))
                .splineToSplineHeading(new Pose2d(37.25,25.5,Math.toRadians(0)), Math.toRadians(-135));
        //.build();
        ...
        TrajectoryActionBuilder pickupSample3 = drive.actionBuilder(new Pose2d(-55,-55, Math.toRadians(-315)))
                .splineToLinearHeading(new Pose2d(44.5,25.5,Math.toRadians(0)), Math.toRadians(-135));
        //.build();
        ...
        TrajectoryActionBuilder parkRobot = drive.actionBuilder(new Pose2d(-55, -55, Math.toRadians(-315)))
                .splineToSplineHeading(new Pose2d(28,40,Math.toRadians(-180)), Math.toRadians(-135))
